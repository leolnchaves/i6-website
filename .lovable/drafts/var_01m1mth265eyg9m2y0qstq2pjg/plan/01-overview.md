# Home mais enxuta: i6Signal e "O que você antecipa" saem

Hoje a home tem duas seções seguidas com mensagens sobrepostas: a seção **Produtos** (i6 Decision Suite, com seletor e fluxo Entrada → Decisão → Valor) e a seção **O que você antecipa**, que repete as três alavancas de decisão e ainda carrega, no fim, o bloco **i6Signal**.
