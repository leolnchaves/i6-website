...
const MetricsSection = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-slate-200/80 to-gray-300/90 backdrop-blur-sm py-6 overflow-hidden relative min-h-[40vh] flex flex-col justify-center">
