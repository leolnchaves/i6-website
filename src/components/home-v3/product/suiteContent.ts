    ...
    products: {
      ...
      items: [
        ...
        },
        {
          ...
          capabilities:
            'The ideal mix per store weighs need, channel capacity and real behavior — participation, margin and buying pattern, not just sales history · Prioritizes by margin or by inventory turnover, according to the commercial goal set for that cycle · Each assortment recommendation comes with its own justification per point of sale — not a generic list applied the same way to everyone · Covers sell-in and sell-out with the same intelligence, not two isolated models at each end of the chain · i6 Signal — predictive conversational layer: ask about the mix in natural language and come out with a decision, not a report',
          flow: {
    ...
    products: {
      ...
      items: [
        ...
        },
        {
          ...
          capabilities:
            'Nivel de confianza declarado por pronóstico (Gold/Silver/Bronze) · Identifica cuando el propio pronóstico se desvía del patrón esperado · Trata el núcleo estable y la cola larga escasa de formas distintas · Baja al granular real — SKU por cliente / punto de venta — sin perder precisión: la exactitud supera el 85% en operaciones maduras · i6 Signal — capa conversacional predictiva: pregunte sobre el pronóstico en lenguaje natural y salga con una decisión, no con un informe',
          flow: {
