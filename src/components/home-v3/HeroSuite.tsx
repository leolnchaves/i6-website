...
const copyByLang = {
  pt: {
    ...
    sub: 'Escolha como aplicar: decisão pronta para operar hoje, ou a plataforma para construir a próxima geração de decisões do seu produto.',
  ...
  en: {
    ...
    sub: 'Choose how to apply it: decisions ready to run today, or the platform to build the next generation of decisions in your product.',
  ...
  es: {
    ...
    sub: 'Elija cómo aplicarla: decisiones listas para operar hoy, o la plataforma para construir la próxima generación de decisiones de su producto.',
