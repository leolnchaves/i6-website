...
import heroPanoramaEn from '@/assets/hero-decisao-panorama-en-v2-transparent.png.asset.json';
import heroMobileEn from '@/assets/hero-decisao-mobile-en-v2-transparent.png.asset.json';
