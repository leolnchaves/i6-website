...
import heroPanoramaPt from '@/assets/hero-decisao-panorama-pt-v3.png.asset.json';
import heroMobilePt from '@/assets/hero-decisao-mobile-pt-v3.png.asset.json';
import heroPanoramaEn from '@/assets/hero-decisao-panorama-en-v2.png.asset.json';
import heroMobileEn from '@/assets/hero-decisao-mobile-en-v2.png.asset.json';
