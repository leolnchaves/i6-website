...
const SinaisSection = () => {
  ...
  const copy = {
    pt: {
      badge: 'SINAIS',
      title: 'Somos especialistas em aplicar IA para transformar\ndados em decisões antecipadas.',
    ...
    en: {
      badge: 'SIGNALS',
      title: 'We are specialists in applying AI to transform\ndata into anticipated decisions.',
  ...
  return (
    <section className="py-14 md:py-20 bg-[#0F172A]">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        {/* Title + Subtitle */}
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-snug max-w-4xl mb-4 whitespace-pre-line">
          {copy.title}
        </h2>
