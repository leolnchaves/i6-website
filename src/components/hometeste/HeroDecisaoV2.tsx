...
// V2 — Diagrama ambiente full-bleed atrás do copy centralizado
const HeroDecisaoV2 = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-[#0B1224] overflow-hidden">
      ...
      <img
        ...
        alt=""
        aria-hidden
        className="absolute inset-0 w-full h-full object-cover pointer-events-none select-none animate-fade-in"
        style={{
          opacity: 0.32,
          maskImage: 'radial-gradient(ellipse at center, transparent 15%, black 65%, transparent 100%)',
          WebkitMaskImage: 'radial-gradient(ellipse at center, transparent 15%, black 65%, transparent 100%)',
        }}
      />

      {/* Halo escuro central pra dar respiro ao copy */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            'radial-gradient(ellipse 50% 45% at center, rgba(11,18,36,0.85) 0%, rgba(11,18,36,0.5) 45%, rgba(11,18,36,0) 80%)',
        }}
      />
