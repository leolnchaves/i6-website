    ...
    <section className="relative min-h-screen flex items-center justify-center bg-[#0B1224] overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <p className="mt-4 text-lg sm:text-xl md:text-2xl font-light text-[#F4845F] tracking-wide">
          Data moves. <span className="drop-shadow-[0_0_40px_rgba(244,132,95,0.9)]" style={{ textShadow: '0 0 40px rgba(244,132,95,1), 0 0 80px rgba(244,132,95,0.7), 0 0 120px rgba(244,132,95,0.5), 0 0 160px rgba(244,132,95,0.3)' }}>You Grow.</span>
        </p>
