...
const ScrollAnimation = () => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {/* Layer 1 - Outermost */}
      <div 
        className="absolute left-1/4 top-1/2 w-[500px] h-[500px] opacity-15"
        style={{
      ...
      {/* Layer 2 */}
      <div 
        className="absolute left-1/3 top-1/2 w-[450px] h-[450px] opacity-20"
        style={{
      ...
      <div 
        className="absolute left-1/2 top-1/2 w-[400px] h-[400px] opacity-25"
        style={{
      ...
      {/* Layer 4 */}
      <div 
        className="absolute right-1/3 top-1/2 w-[450px] h-[450px] opacity-20"
        style={{
      ...
      <div 
        className="absolute right-1/4 top-1/2 w-[500px] h-[500px] opacity-15"
        style={{
      ...
      {/* Central glowing core - Increased size */}
      <div 
        className="absolute left-1/2 top-1/2 w-48 h-48 opacity-40"
        style={{
