          ...
          <div className="max-w-5xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/contact#contact-form" className="block w-full sm:w-auto">
                <Button size="lg" className="bg-primary text-white rounded-lg font-medium shadow-lg hover:shadow-xl transition-all flex items-center gap-2 w-full sm:w-auto whitespace-nowrap h-11" onClick={() => logger.info('Start journey button clicked', undefined, 'HeroSection')}>
                  {t('hero.startJourney')}
                  <ArrowRight className="w-5 h-5" />
                </Button>
              </Link>
              <Button size="lg" className="bg-white/20 backdrop-blur-sm text-white border border-white/30 rounded-lg font-medium shadow-lg hover:bg-white/30 hover:shadow-xl transition-all flex items-center gap-2 w-full sm:w-auto whitespace-nowrap h-11" onClick={handleOpenVideoModal}>
                {t('hero.watchDemo')}
              </Button>
            </div>
          </div>
