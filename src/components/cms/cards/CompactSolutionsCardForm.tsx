...
interface CompactSolutionsCardFormProps {
  card: CompactSolutionsCard;
  index: number;
  availableIcons: Array<{ value: string; label: string }>;
  availableEngines: string[];
  totalCards: number;
  onChange: (index: number, field: keyof CompactSolutionsCard, value: any) => void;
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => onChange(index, 'background_opacity', parseFloat(e.target.value))}
                className="flex-1"
              />
