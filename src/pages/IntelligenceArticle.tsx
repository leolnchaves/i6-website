...
const IntelligenceArticle = () => {
  ...
  const pdfUrl = piece.asset_url
    ...
    : null;
  const hasBody = piece.content.trim() !== '';

  /** Entrega do PDF por e-mail. Complementa o artigo; só substitui o corpo
   *  quando a peça realmente não tem texto. */
  const assetDelivery = piece.asset_url ? (
    <>
      ...
      <article className="container mx-auto px-6 pt-32 pb-20 max-w-3xl">
        ...
        {isLocked ? (
          ...
          <>
            ...
            {/* PDF complementa o artigo; quando não há texto, ocupa o lugar dele. */}
            {assetDelivery}
