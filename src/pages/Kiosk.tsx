      ...
      >
        ...
        {stage === 'results' && (
          <div className="w-full max-w-[96vw] mx-auto px-[4vmin] pt-[10vmin] pb-[8vmin]">
            ...
            {(() => {
              const migratedIds = ['predictive-personalization', 'smart-discovery', 'predictive-campaign-targeting', 'demand-forecasting', 'predictive-commercial-targets', 'mix-assortment-order', 'price-to-margin'];
