...
language: pt
section: research
section_label: "Pesquisa"
order: 60
description: "Palestras técnicas e artigos publicados pelo time da i6 em conferências e repositórios abertos, complementando a produção formal revisada por pares."
site_managed: true
---

As publicações formais revisadas por pares estão reunidas em [i6 Deep Research](/pt/i6-intelligence). Esta página complementa aquela lista com a produção técnica aberta: palestras em conferência e artigos depositados em repositório público, sem revisão por pares.
...
Depositados no Academia.edu, sem revisão por pares.
