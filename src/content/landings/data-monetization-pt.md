---
title: "Monetização de Dados com IA Aplicada"
...
- Personalização que para no e-mail e não chega ao PDV.
...
- **i6 RecSys** — recomendação em tempo real e propensão de compra para clientes anônimos, com score por SKU, canal e momento.
...
- **Anonimização nativa** — opera sobre dados anonimizados, LGPD-friendly por design.
...
**Como fica a LGPD?**
Operação em dados anonimizados é nativa. Não trafegamos PII; o engine trabalha com identificadores hash + atributos comportamentais.

**Os modelos viram caixa-preta para o time comercial?**
Não. Cada recomendação retorna os fatores que a sustentam (explicabilidade por feature) — vira argumento de venda, não imposição opaca.

**Funciona para clientes anônimos sem login?**
Sim. O i6 RecSys gera propensão de compra para tráfego anônimo com base em padrão de sessão, contexto e similaridade.
