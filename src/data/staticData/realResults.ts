...
export const realResults: RealResultKPI[] = [
  ...
  },
  {
    ...
    label: {
      pt: 'ticket médio por PDV',
      en: 'average ticket per POS',
      es: 'ticket medio por punto de venta',
    },
  ...
  },
  {
    ...
    label: {
      pt: 'positivação de produtos',
      en: 'product activation',
      es: 'activación de productos',
    },
    source: { pt: 'Varejo', en: 'Retail', es: 'Retail' },
    numericValue: 36,
    unitText: 'percent',
