...
export const contactCopy: { pt: ContactCopy; en: ContactCopy; es: ContactCopy } = {
  pt: {
    ...
    triage: {
      ...
      footnote: 'Se é sobre o i6 Decision Suite ou outro assunto, continue abaixo.',
    },
    faq: {
      ...
      items: [
        ...
        { id: 4, question: 'Qual a diferença entre o i6 Decision Suite e o i6 Builder Platform?', answer: 'O i6 Decision Suite é o conjunto de aplicações prontas da i6 — forecasting, pricing, assortment, sales planning, discovery e targeting — para quem quer usar a inteligência diretamente. O i6 Builder Platform é a camada de plataforma por trás disso: os mesmos motores, expostos via SDKs, APIs e toolkits, para quem quer construir seus próprios produtos usando essa inteligência como base.' },
        { id: 5, question: 'Como funciona a Comunidade de builders?', answer: 'A Comunidade i6 conecta quem constrói sobre o i6 Builder Platform — troca técnica entre pares, eventos como Office Hours e Meetups, e reconhecimento de quem está implementando de verdade. Veja mais em /community.' },
