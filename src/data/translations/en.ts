...
export const enTranslations = {
  ...
  // Insights — i6 On Media
  'insights.badge': 'I6 ON MEDIA',
  'insights.pageTitle': 'i6 On Media',
  'insights.pageSubtitle': 'Interviews, mentions and posts from the infinity6 team across press outlets and social networks.',
  'insights.itemsLabel': 'publications',
  'insights.empty': 'New publications coming soon',
  'insights.viewOriginal': 'View original',
  'insights.viewOriginalAria': 'View original (opens in a new tab)',
  'insights.readOnSite': 'Read on site',
  ...
  'successStories.testimonials.title': 'In their words: those already deciding first.',
  'successStories.testimonials.subtitle': 'Leaders share how anticipated decisions are driving real business impact.',
  ...
  'contact.faq.a6': 'Yes. Our platform is API-first and cloud-based. The i6RecSys, i6Previsio and i6ElasticPrice engines expose REST APIs that connect to ERPs, CRMs, e-commerce platforms and internal data sources, with i6Signal as the conversational layer on top of them.',
  ...
  'contact.form.messageDescription': 'Describe your goal, challenge or question. The more context you provide, the better we can guide the conversation.',
