...
export const ptTranslations = {
  ...
  'header.suiteCta': 'Acesse o i6 Decision Suite',
  ...
  'hero.rethinkLine2': 'Cresça sem limites com IA adaptativa.',
  'hero.startJourney': 'Comece sua Jornada',
  'hero.watchDemo': 'Veja o Futuro',
  
  // Results Section
  'results.mainTitle': 'Impacto Real da IA',
  'results.mainSubtitle': 'Escalando o Crescimento dos Negócios',
  'results.title': 'Impacto Real de IA que Impulsiona o Crescimento dos Negócios',
  'results.subtitle1': 'Chega de inteligência superficial. Chega de atrasos. Chega de complexidade.',
  'results.subtitle2': 'Nós entregamos resultados que realmente importam: mais vendas, melhores margens, operações mais ágeis e estratégias mais eficientes - tudo com inteligência aplicada.',
  ...
  'compactSolutions.title': 'IA Aplicada, Modelada para Resultados',
  ...
  'successStories.testimonials.title': 'Com a palavra: quem já está decidindo antes.',
  'successStories.testimonials.subtitle': 'Líderes compartilham como decisões antecipadas estão gerando impacto real nos negócios.',
  ...
  'contact.form.messageDescription': 'Descreva seu objetivo, desafio ou dúvida. Quanto mais contexto, melhor podemos direcionar sua conversa.',
